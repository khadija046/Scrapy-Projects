...
class CedarrapidsSpider(scrapy.Spider):
    name = 'cedarrapids'
    start_urls = ['https://web.cedarrapids.org/allcategories']

    base_url = 'https://web.cedarrapids.org{}'
    custom_settings = {
        'FEED_URI': 'cedarrapids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.cedarrapids.org/allcategories'
            item['Lead_Source'] = 'cedarrapids'

...
class ChesterfieldmochamberSpider(scrapy.Spider):
    name = 'chesterfieldmochamber'
    start_urls = ['https://www.chesterfieldmochamber.com/list/']

    custom_settings = {
        'FEED_URI': 'chesterfieldmochamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.chesterfieldmochamber.com/list/'
            ...
            item['Lead_Source'] = 'chesterfieldmochamber'

...
class BrowncountyohiochamberSpider(scrapy.Spider):
    name = 'browncountyohiochamber'
    start_urls = ['https://business.browncountyohiochamber.com/list']

    custom_settings = {
        'FEED_URI': 'browncountyohiochamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            item = response.meta['item']
            item['Business Name'] = response.css('h1.fl-heading span::text').get('').strip()
            ...
            item['Source_URL'] = 'https://business.browncountyohiochamber.com/list/'
            ...
            item['Lead_Source'] = 'browncountyohiochamber'

...
class AddisoncountySpider(scrapy.Spider):
    name = 'addisoncounty'
    start_urls = ['https://www.addisoncounty.com/list/']

    custom_settings = {
        'FEED_URI': 'addisoncounty.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.addisoncounty.com/list/'
            ...
            item['Lead_Source'] = 'addisoncounty'

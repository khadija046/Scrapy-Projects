...
class CarygrovechamberSpider(scrapy.Spider):
    name = 'carygrovechamber'
    start_urls = ['https://business.carygrovechamber.com/list']

    custom_settings = {
        'FEED_URI': 'carygrovechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.carygrovechamber.com/list'
            ...
            item['Lead_Source'] = 'carygrovechamber'

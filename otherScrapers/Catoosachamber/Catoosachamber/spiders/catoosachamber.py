...
class CatoosachamberSpider(scrapy.Spider):
    name = 'catoosachamber'
    start_urls = ['https://business.catoosachamberofcommerce.com/list']

    custom_settings = {
        'FEED_URI': 'catoosachamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.catoosachamberofcommerce.com/list'
            ...
            item['Lead_Source'] = 'catoosachamberofcommerce'

...
class AkronhbaSpider(scrapy.Spider):
    name = 'akronhba'
    start_urls = ['https://www.akronhba.com/list']

    custom_settings = {
        'FEED_URI': 'akronhba.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.akronhba.com/list'

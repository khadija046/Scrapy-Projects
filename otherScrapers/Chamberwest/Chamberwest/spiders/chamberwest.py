...
class ChamberwestSpider(scrapy.Spider):
    name = 'chamberwest'
    start_urls = ['https://business.chamberwest.com/list']

    custom_settings = {
        'FEED_URI': 'chamberwest.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.chamberwest.com/list'
